...
const waJS = [
  ...
  'd.innerHTML=\'<div class="flex flex-col gap-1 items-end"><div class="max-w-[80%] rounded-lg bg-emerald-500 px-3 py-2 text-sm text-white shadow-sm self-end">\'+html+\'</div></div>\';',
  '}else{',
  'd.className="flex gap-2.5 justify-start";',
  'd.innerHTML=\'<div class="flex h-8 w-8 shrink-0 items-center justify-center overflow-hidden rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 text-white"><span class="text-[10px] font-bold">BI</span></div><div class="flex flex-col gap-1"><div class="max-w-[80%] rounded-lg bg-slate-100 px-3 py-2 text-sm text-slate-800 shadow-sm self-start">\'+html+\'</div></div>\';',
  '}',
  'M.appendChild(d);',
  ...
  'b.className="text-[11px] rounded-full bg-emerald-50 px-3 py-1.5 text-emerald-700 hover:bg-emerald-100 transition font-medium";',
  'b.textContent=label;',
  'w.appendChild(b);',
  'f.appendChild(w);',
  '});',
...
console.log('✅ Archivo generado:', 'public/js/whatsapp-chat.js');
console.log('📊 Tamaño:', waJS.length, 'bytes');
console.log('📏 Líneas:', waJS.split('\n').length);
