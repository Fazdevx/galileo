...
var middlewareSecret = "029ccdbf-bd28-4590-99b4-95da3a3ccb71";
//#endregion
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "029ccdbf-bd28-4590-99b4-95da3a3ccb71") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
