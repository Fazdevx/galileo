...
var middlewareSecret = "18a96c60-5e11-4842-ac5e-b1773137ec77";
//#endregion
...
var _page2 = () => import("./chunks/save-data_BetaFMHb.mjs");
...
var entrypoint_default = { async fetch(request) {
	...
	else if (url.searchParams.get("x_astro_path_token") === "18a96c60-5e11-4842-ac5e-b1773137ec77") realPath = url.searchParams.get(ASTRO_PATH_PARAM);
